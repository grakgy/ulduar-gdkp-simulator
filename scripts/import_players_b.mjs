...
const playersB = [
  { id: 'P103', name: '苏三先生', cls: '法师', spec: '火法', role: '远程DPS', ilvl: 227, offspec: '', progress: '10人全通', publicEconomy: '有提升会出', whisper: '全通火法|爆发窗口熟练|有提升会出', tier: '优秀', skill: 85, mechanics: 85, awareness: 82, stability: 72, teamwork: 80, learning: 78, mentality: 78, pressure: 80, primary: '稳定型', secondary: '气氛组', leave: 0, economy: '实力消费', wallet: 50000, reserve: 12000, spend: 68, aggression: 60, bargain: .75, preference: '全部|合理提升', honesty: 94, personality: '高上限火法', strengths: '高输出上限|全Boss经验|爆发窗口把握', weaknesses: '不同Boss发挥差异较大|个别机制战发挥偏低', rule: '', policy: '永不主动退队', description: '227装等火法，整体优秀，爆发窗口把握较好；不同Boss发挥存在一定波动。', specs: [['火法', '远程DPS', 85, 90]] },
  { id: 'P104', name: '冰冻玫瑰', cls: '法师', spec: '火法', role: '远程DPS', ilvl: 224, offspec: '', progress: '10人全通', publicEconomy: '有便宜就拿', whisper: '全通熟练|可以帮忙指挥|便宜法系装会拿', tier: '顶级', skill: 87, mechanics: 95, awareness: 95, stability: 90, teamwork: 90, learning: 88, mentality: 88, pressure: 84, primary: '团长型', secondary: '责任型', leave: 0, economy: '排骨党', wallet: 8000, reserve: 2500, spend: 12, aggression: 8, bargain: .2, preference: '低价', honesty: 95, personality: '指挥会长型', strengths: '操作优秀|全Boss经验丰富|可组织指挥|团队执行强', weaknesses: '极低概率网络波动', rule: '', policy: '永不主动退队', description: '指挥会长型老玩家，操作、机制和团队执行都很强；消费谨慎，主要目标是分金。', specs: [['火法', '远程DPS', 87, 90]] },
  { id: 'P105', name: '李一桐', cls: '术士', spec: '恶魔术', role: '远程DPS', ilvl: 232, offspec: '痛苦术', progress: '10人全通', publicEconomy: '只看极品', whisper: '恶魔术全通|可切痛苦|只看极品', tier: '顶级', skill: 85, mechanics: 90, awareness: 96, stability: 91, teamwork: 90, learning: 88, mentality: 88, pressure: 84, primary: '团长型', secondary: '团队执行', leave: 0, economy: '毕业装党', wallet: 120000, reserve: 25000, spend: 88, aggression: 78, bargain: .9, preference: 'S|S+|武器|饰品', honesty: 95, personality: '高水平极品消费恶魔术', strengths: '操作优秀|全Boss经验丰富|团队增益|稳定执行', weaknesses: '普通提升购买意愿低', rule: '', policy: '永不主动退队', description: '高质量恶魔术，操作扎实、团队增益明确；只对S/S+或毕业件积极出手。', specs: [['恶魔术', '远程DPS', 85, 90], ['痛苦术', '远程DPS', 82, 88]] },
  { id: 'P106', name: '鹿乃乃乃乃', cls: '德鲁伊', spec: '鸟德', role: '远程DPS', ilvl: 216, offspec: '', progress: '10人熟练', publicEconomy: '有提升会出', whisper: '鸟德熟练|有提升会出|会打所有机制', tier: '中上', skill: 77, mechanics: 75, awareness: 78, stability: 65, teamwork: 62, learning: 72, mentality: 55, pressure: 50, primary: '自信型', secondary: '玻璃心', leave: 6.5, economy: '实力消费', wallet: 45000, reserve: 10000, spend: 72, aggression: 58, bargain: .75, preference: '全部|合理提升', honesty: 95, personality: '嘴强王者公主病', strengths: '操作扎实|副本经验丰富|自信心强', weaknesses: '需要被照顾|被质疑后容易玻璃心|团队配合一般', rule: '高士气时小幅加成；被点名后退队倾向增加', policy: '条件退队', description: '实战中上但嘴上气势更强，被点名或缺少照顾时心态容易下降。', specs: [['鸟德', '远程DPS', 77, 75]] },
  ...
  { id: 'P116', name: '随先生', cls: '术士', spec: '痛苦术', role: '远程DPS', ilvl: 215, offspec: '', progress: '小号无成就', publicEconomy: '有便宜就拿', whisper: '痛苦术补位|便宜法系装会拿|小号求组', tier: '偏弱', skill: 68, mechanics: 62, awareness: 52, stability: 46, teamwork: 66, learning: 62, mentality: 60, pressure: 58, primary: '沉默型', secondary: '无', leave: 0, economy: '捡漏型', wallet: 15000, reserve: 4000, spend: 30, aggression: 22, bargain: .5, preference: '低价|法系', honesty: 90, personality: '低分痛苦术', strengths: '可提供持续输出', weaknesses: '输出上限有限|稳定性偏低|样本较少', rule: '', policy: '永不主动退队', description: '更适合作为低配补位输出，实战上限有限，出价保守。', specs: [['痛苦术', '远程DPS', 68, 42]] },
  ...
  { id: 'P118', name: '雨宫天', cls: '圣骑士', spec: '奶骑', role: '治疗', ilvl: 225, offspec: '', progress: '回归玩家', publicEconomy: '无限预算，想买就买', whisper: '奶骑回归|治疗装都买|预算不是问题', tier: '优秀', skill: 90, mechanics: 80, awareness: 82, stability: 78, teamwork: 88, learning: 94, mentality: 82, pressure: 80, primary: '责任型', secondary: '团队执行', leave: 0, economy: '大老板', wallet: 999999999, reserve: 0, spend: 100, aggression: 100, bargain: 1.2, preference: '全部', honesty: 100, personality: '无限金币成长型奶骑', strengths: '操作优秀|单体治疗能力强|学习速度快|购买欲极强', weaknesses: 'Boss经验较少|复杂机制需要熟悉', rule: '钱包视为无限；所有适用装备均有购买意愿', policy: '永不主动退队', description: '操作优秀但Boss经验较少，学习速度快；经济上视为无限预算。', specs: [['奶骑', '治疗', 90, 35]] },
  { id: 'P119', name: '辉夜萨麻', cls: '萨满', spec: '奶萨', role: '治疗', ilvl: 221, offspec: '', progress: '小号无成就', publicEconomy: '有提升会出', whisper: '奶萨补位|治疗装备会出|听指挥', tier: '中上', skill: 73, mechanics: 48, awareness: 72, stability: 70, teamwork: 88, learning: 74, mentality: 78, pressure: 76, primary: '责任型', secondary: '团队执行', leave: 0, economy: '实力消费', wallet: 34000, reserve: 8500, spend: 58, aggression: 45, bargain: .7, preference: '治疗|合理提升', honesty: 94, personality: '中等奶萨', strengths: '治疗发挥稳定|团队辅助', weaknesses: '机制经验有限|高分上限暂未体现', rule: '', policy: '永不主动退队', description: '治疗表现中等偏稳，团队辅助意识较好，但高难机制经验有限。', specs: [['奶萨', '治疗', 73, 48]] },
  { id: 'P120', name: '安德罗波夫', cls: '死亡骑士', spec: '邪DK', role: '近战DPS', ilvl: 231, offspec: '血DK', progress: '10人全通', publicEconomy: '毕业必买', whisper: '邪DK全通|可切血DK|毕业装会出', tier: '顶级', skill: 95, mechanics: 96, awareness: 96, stability: 94, teamwork: 85, learning: 98, mentality: 90, pressure: 55, primary: '团长型', secondary: '钻空子', leave: 0, economy: '毕业装党', wallet: 100000, reserve: 30000, spend: 90, aggression: 80, bargain: 1, preference: 'S|S+|武器|饰品', honesty: 95, personality: '初中肄业小号', strengths: '顶级输出|全Boss熟练|可指挥|可切坦克', weaknesses: '低水平团队中容易心灰意冷', rule: '可与初中肄业同时出现；低质量连续灭团后退队率提高', policy: '特殊事件退队', description: '初中肄业的小号，继承高个人能力、经验和规则倾向；主修邪DK，副修血DK。', specs: [['邪DK', '近战DPS', 95, 98], ['血DK', '坦克', 88, 98]] },
]
...
for (const player of playersB) {
  ...
  nextHidden.push({
    ...
    reserve_gold: String(player.reserve),
